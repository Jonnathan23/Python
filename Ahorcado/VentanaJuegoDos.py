...
class VentanaJuego:
    def __init__(self,wordGuess, phraseGuess):        
        ...
        self.btM = createBt(self.framePlay,"M", 4,0)
        self.btN = createBt(self.framePlay,"N", 4,1)
        self.btNE = createBt(self.framePlay,"Ñ", 4,2)
        self.btO = createBt(self.framePlay,"O", 4,3)
        
        self.btP = createBt(self.framePlay,"P", 5,0)
        self.btQ = createBt(self.framePlay,"Q", 5,1)
        self.btR = createBt(self.framePlay,"R", 5,2)
        self.btS = createBt(self.framePlay,"S", 5,3)
        
        self.btT = createBt(self.framePlay,"T", 6,0)
        self.btU = createBt(self.framePlay,"U", 6,1)
        self.btV = createBt(self.framePlay,"V", 6,2)
        self.btW = createBt(self.framePlay,"W", 6,3)
        
        self.btX = createBt(self.framePlay,"X", 7,0)
        self.btY = createBt(self.framePlay,"Y", 7,1)
        self.btZ = createBt(self.framePlay,"Z", 7,2)
